...
<body style="background:url('images/image0.jpg') top right no-repeat;">
...
if($user_data['skype']!=''){
  ?>
        <a href="https://api.whatsapp.com/send?phone=<?=$user_data['skype']?>" class="google-plus"><i class="icofont-whatsapp"></i></a>
  <?php
}
if($user_data['linkedin']!=''){
  ?>
        <a href="https://www.linkedin.com/in/<?=$user_data['linkedin']?>" class="linkedin"><i class="icofont-linkedin"></i></a>
   <?php
}
   ?>
      </div>
...
<li><i class="icofont-rounded-right"></i>  Hello, I'm Yash Rastogi, a passionate and dedicated web developer currently contributing my skills at Thinkexam in Noida. Holding a post-graduate degree in MCA, I find myself immersed in the dynamic world of software development.

At Thinkexam, I play a crucial role as a Software Developer, focusing primarily on web development. The company, driven by Ginger Webs Pvt. Ltd., is on a mission to excel in the field of online examinations, a goal that strongly resonates with my professional aspirations.</li>
...
?>
       ...
       <div class="col-lg-6" style="margin-left: 558px;margin-top: -701px;">
         
          

         <h3 class="resume-title">Competencies</h3>
<?php
...
if($user_data['linkedin']!=''){
  ...
  <div class="credits">
    ...
    Designed by <a href="https://www.youtube.com/channel/UCtpdZTndGnAyX-8uxUdTDnQ">Yash Rastogi</a>
  </div>
